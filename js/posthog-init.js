...
(function () {
  ...
  var shouldLoadWhenIdle = currentScript && currentScript.dataset.load === 'idle';

  function schedulePostHogInit(callback) {
  ...
  if (consent && consent.granted) {
    ...
    window.addEventListener('consentGranted', function () { initPostHog(); }, { once: true });
  }
})();
